...
class URLChecker_Util:
    ...
    def __init__(self, TLD_CACHED_FILE='tld_cache.dat', ALEX_TOP_CACHED_FILE='alex_top_1m.txt'):
        ...
        print 'id_URLChecker_Util.alex_top ', id(URLChecker_Util.alex_top)
        print 'id_URLChecker_Util.tld_cache ', id(URLChecker_Util.tld_cache)
    ...
    def env_init(self):
        ...
        print self.TLD_CACHED_FILE
        print self.ALEX_TOP_CACHED_FILE
